...
const EarlyBooking: React.FC = () => {
  ...
  const benefits = [
    { icon: <Calendar className="w-8 h-8" />, titleKey: 'earlyBooking.benefit1Title', descKey: 'earlyBooking.benefit1Desc' },
    { icon: <Award className="w-8 h-8" />, titleKey: 'earlyBooking.benefit2Title', descKey: 'earlyBooking.benefit2Desc' },
    { icon: <Shield className="w-8 h-8" />, titleKey: 'earlyBooking.benefit3Title', descKey: 'earlyBooking.benefit3Desc' },
    { icon: <Users className="w-8 h-8" />, titleKey: 'earlyBooking.benefit4Title', descKey: 'earlyBooking.benefit4Desc' },
  ];
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          <div className="mb-12 lg:mb-0">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
              {t('earlyBooking.heading1')}
              <span className="text-orange-500 block">{t('earlyBooking.heading2')}</span>
            </h2>
            
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
              {t('earlyBooking.description')}
            </p>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200">
                  <div className="flex-shrink-0 text-orange-500">{benefit.icon}</div>
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-1">{t(benefit.titleKey)}</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">{t(benefit.descKey)}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img src="https://images.pexels.com/photos/1320684/pexels-photo-1320684.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop" alt={t('earlyBooking.title')} className="w-full h-96 lg:h-[500px] object-cover" />
            ...
            <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-xl border border-gray-100 dark:border-gray-700">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">{t('earlyBooking.discountLabel')}</div>
                </div>
              </div>
            </div>
            <div className="absolute top-6 right-6 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl p-4">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400">{t('earlyBooking.happyCustomers')}</div>
              </div>
            </div>
          </div>
        </div>
