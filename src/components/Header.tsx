        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button
                onClick={() => { setShowHelp(!showHelp); setShowAccount(false); }}
                className="flex items-center space-x-2 p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
              >
            ...
            <div className="relative">
              {user ? (
                <>
                  <button
                    onClick={() => { setShowAccount(!showAccount); setShowHelp(false); }}
                    className="flex items-center space-x-2 p-2 text-orange-500 hover:text-orange-600 transition-colors duration-200"
                  >
                    ...
                    <span className="hidden md:inline text-sm font-medium text-gray-700 dark:text-gray-300">Hesabım</span>
                  </button>
                  ...
                  {showAccount && (
                    <div className="absolute right-0 top-full mt-2 w-52 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-2 z-50">
                      ...
                      <Link
                        ...
                        className="flex items-center gap-2 w-full text-left px-3 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-800 dark:text-white text-sm"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 w-full text-left px-3 py-2.5 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors text-red-500 text-sm"
                      >
                ...
                <>
                  ...
                  {showAccount && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-2 z-50">
                      <button
                        onClick={() => { setShowAccount(false); onOpenAuth('login'); }}
                        className="w-full text-left px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-900 dark:text-white text-sm"
                      >
                        Daxil ol
                      </button>
                      <button
                        onClick={() => { setShowAccount(false); onOpenAuth('register'); }}
                        className="w-full text-left px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-900 dark:text-white text-sm"
                      >
                        Qeydiyyat
                      </button>
        ...
        <div className="lg:hidden bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 px-4 py-4">
          <div className="space-y-3">
            <div className="flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">
              ...
              <input type="text" placeholder="Hara getmək istəyirsiniz?" className="bg-transparent text-sm text-gray-700 dark:text-gray-300 placeholder-gray-400 border-none outline-none flex-1" />
            </div>
            <div className="flex space-x-2">
              <div className="flex-1 flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">
                <Calendar className="w-4 h-4 text-gray-400" />
                <input type="text" placeholder="Tarix" className="bg-transparent text-sm text-gray-700 dark:text-gray-300 placeholder-gray-400 border-none outline-none flex-1" />
              </div>
              <div className="flex-1 flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 rounded-lg px-3 py-2">
                <Users className="w-4 h-4 text-gray-400" />
                <input type="text" placeholder="Qonaq" className="bg-transparent text-sm text-gray-700 dark:text-gray-300 placeholder-gray-400 border-none outline-none flex-1" />
              </div>
            </div>
