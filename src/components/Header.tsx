...
import { Search, MapPin, Calendar, Users, Moon, Sun, Menu, X, HelpCircle, User, Phone, MessageCircle, Settings, Info, Mail, LogOut } from 'lucide-react';
                  ...
                  {showAccount && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-2 z-50">
                      <Link
                        ...
                        className="w-full text-left px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 text-gray-900 dark:text-white flex items-center space-x-2"
                      >
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-2 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition-colors duration-200 text-red-500 flex items-center space-x-2"
                      >
